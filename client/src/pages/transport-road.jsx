...
import { MET_BHUJBAL_LOCATION, requestCurrentLocation } from '@/lib/location-config';
...
export default function TransportRoad() {
  ...
  // Initialize map
  const initializeMap = (center = MET_BHUJBAL_LOCATION) => {
  ...
  const drawCustomRoute = (startLocation, endLocation = MET_BHUJBAL_LOCATION) => {
  ...
  const calculateRoute = (startLocation, endLocation = MET_BHUJBAL_LOCATION) => {
  ...
  const calculateFallbackRoute = (city) => {
    ...
    const nashikLocation = MET_BHUJBAL_LOCATION;
